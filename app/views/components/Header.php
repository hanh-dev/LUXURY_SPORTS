                        ...
                        <li class="menu-item category">
                            ...
                            <ul class="sub_menu">
                                <li class="sub_menu-item">
                                    ...
                                    <a href="#" class="sub-item">Football</a>
                                </li>
                                <li class="sub_menu-item">
                                    <i class="fa-solid fa-arrow-right"></i>
                                    <a href="#" class="sub-item">Basketball</a>
                                </li>
                                <li class="sub_menu-item">
                                    <i class="fa-solid fa-arrow-right"></i>
                                    <a href="#" class="sub-item">Tennis</a>
                                </li>
                                <li class="sub_menu-item">
                                    <i class="fa-solid fa-arrow-right"></i>
                                    <a href="#" class="sub-item">Pickleball</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item">
            ...
            <div class="header_left">
                <div class="elementor-widget-container">
                    ...
                    <div class="kitify-cart">
                        <a href="<?= isset($_SESSION['user_id']) ? 'Cart' : 'Login'; ?>">
                        ...
                        <div class="cart_text" id="display_quantity">
                        <!-- Display quantity of items in cart of user_id -->
                        </div>
                    </div>
                </div>
            </div>
