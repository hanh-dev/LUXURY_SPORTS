    ...
    <div class="site_footer">
        <div class="footer-box">
            <div class="footer_left">
                <div class="left_tile_shop">
                    <h3>LUXURY SPORTS</h3>
                </div>
                <div class="intr_shop">
                    <p>
                    Luxury Sports is health and wellness destination for looking well, feeling well, and performing well. Our role is to help motivate everyone to get moving and help them achieve their wellness goals.
                    </p>
                </div>
                ...
                <div class="">
                    <span class="elementor-heading-title elementor-size-default">© 2024 PNV Students. Designed by Luxury</span>
                </div>
            </div>
            <div class="footer-center">
                <div class="center_title">
                    <h3>Customer Supporter</h3>
                </div>
